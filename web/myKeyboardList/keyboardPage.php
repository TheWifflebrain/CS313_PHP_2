    ...
    <table class="table table-striped">
      <tbody>
        ...
        ?>
          ...
          <td>
            <input onclick="editComment()" type="submit" name="Edit" value="Edit" class="btn btn-info btn-block"></a>
          </td>
          <td>
            <input onclick="doublecheck2()" type="button" name="Remove" value="Remove" class="btn btn-info btn-block">
          </td>
        <?php 
          }
        ?>          
