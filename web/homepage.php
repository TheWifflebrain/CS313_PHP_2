...
<body>
    ...
    <h1 class="jumbotron text-center bg-dark">Super Smash Bros. Ultimate</h1>
    <?php
        require("navbar.php");
    ?>
    ...
    <div>
        <h2>About</h2>
        <p>
            Super Smash Bros. Ultimate[b] is a 2018 crossover fighting game developed by Bandai Namco Studios and Sora Ltd., 
